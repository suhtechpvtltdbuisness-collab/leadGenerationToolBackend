...
const buildClientOptions = () => {
    ...
    if (isProd) {
        ...
        // Optional escape hatch for environments with custom / self‑signed certs
...
const getMongoUri = () => {
    ...
    if (!uri) {
        throw new Error('MongoDB connection string is not defined. Set MONGODB_URI or DATABASSURL in your environment.');
    }
    return uri;
};
